...
var Context = /** @class */ (function () {
     ...
     */
    function Context(components, database, options, hydrationCompletedCallback, databaseName) {
        this.options = options;
        this.components = components;
        this.database = database;
        this.hydrationCompletedCallback = hydrationCompletedCallback;
        var name = databaseName || 'vuex-orm-loki';
    ...
    Context.prototype.autoLoadCallback = function () {
        ...
        Object.keys(this.database.models()).forEach(function (key) {
            if (_this.loki.getCollection(_this.database.models()[key].entity) === null) {
                _this.loki.addCollection(_this.database.models()[key].entity);
            }
            ;
        });
        Object.keys(this.database.models()).forEach(function (key) {
            var lokiData = _this.loki.getCollection(_this.database.models()[key].entity).data;
     ...
     * @param {string} databaseName custom name for the LokiJS database (optional)
     */
    Context.setup = function (components, database, options, hydrationCompletedCallback, databaseName) {
